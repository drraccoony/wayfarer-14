...
corp-station-upkeep-cost = Upkeep: {NUMBER($amount, useGrouping: 1)} spesos / round
...
corp-notify-upkeep-charged = [CORP] Station upkeep of {NUMBER($amount, useGrouping: 1)} spesos has been deducted from your corporation's bank account.
corp-notify-upkeep-evicted = [CORP] Your corporation could not afford the station upkeep of {NUMBER($amount, useGrouping: 1)} spesos. The station has been blasted from the sector by Zekke landlords and all materials has been lost.
